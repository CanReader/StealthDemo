...
AMissionGameMode::AMissionGameMode() : LevelNames({ "Test", "Level_1","Level_2","Level_3" })
{
...
void AMissionGameMode::BeginPlay()
{
    ...
    FSoftObjectPath SoundPathObj(SoundPath);
    FAssetData SoundAssetData = AssetRegistryModule.Get().GetAssetByObjectPath(SoundPathObj);
