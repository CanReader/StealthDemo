 ...
 */
UCLASS()
class CANBERKAIDEMO_API ABaseAIController : public AAIController
{
    GENERATED_BODY()
...
public:
    ...
    UFUNCTION(BlueprintCallable)
    virtual void SetAwarnessState(EPlayerAwarenessState state);
    UFUNCTION(BlueprintCallable)
...
protected:
    ...
    float SightForgetTime = 12.f;

    UPROPERTY(EditDefaultsOnly, Category = "AI")
    float HeardForgetTime = 12.f;
    ...
    FTimerHandle SightForgetTimerHandle;
    FTimerHandle HeardForgetTimerHandle;
